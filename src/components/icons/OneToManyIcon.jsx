...
export function OneToManyIcon({ id, color }) {
  return (
    <>
      <defs>
        <Gradient
      ...
      <LightMode>
        ...
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g id="SVGRepo_iconCarrier"> 
            <path d="M42 7H6C4.89543 7 4 7.89543 4 9V39C4 40.1046 4.89543 41 6 41H42C43.1046 41 44 40.1046 44 39V9C44 7.89543 43.1046 7 42 7Z" fill="" stroke="#000000" strokeWidth="3"></path> 
            <path d="M11 20.5799L15 18V30" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"></path> 
            <path d="M29 30V18L37 30V18" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"></path> 
            <path d="M22 20V21" stroke="#000000" strokeWidth="3" strokeLinecap="round"></path> 
            <path d="M22 27V28" stroke="#000000" strokeWidth="3" strokeLinecap="round"></path> 
          </g>
        </svg>
      </LightMode>
